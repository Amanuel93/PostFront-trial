...
// import { loginUserStart,resetError } from '../../redux/authSlice'; // Adjust the path based on your file structure
...
//   // Clear error and reset fields after 2 seconds
//   useEffect(() => {
//     if (error) {
...
import { Link, useNavigate } from 'react-router-dom';
import { useDispatch, useSelector } from 'react-redux';
import { loginUserStart, resetError } from '../../redux/authSlice';
import Spinners from '../Common/spinner';
